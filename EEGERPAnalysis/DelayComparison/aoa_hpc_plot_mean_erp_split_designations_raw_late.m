%% Groups and plots ERPs for late delays (6-8s)
...
for session = 1:length(allSubjectNames)
    ...
    mean_aware_erp = mean_aware_erp_late;
    mean_unaware_erp = mean_unaware_erp_late;
    awareTotals = awareTotals_late;
    unawareTotals = unawareTotals_late;
...
creationFunction = 'aoa_hpc_plot_mean_erp_split_designations_raw_late.m'
save('/vast/palmer/pi/blumenfeld/dsj8/AoA_Study/aoa_group_erp_means_split_designations_raw_late.mat','avg_erp_all_channels_aware_subjects','avg_erp_all_channels_unaware_subjects','allSubjectMeansAware','allSubjectMeansUnaware','creationFunction')
