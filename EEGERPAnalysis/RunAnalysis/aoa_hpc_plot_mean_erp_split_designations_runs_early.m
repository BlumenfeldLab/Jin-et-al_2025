%% Creates and saves group mean data for early runs (1-3)
...
for session = 1:length(allSubjectNames)
    ...
    mean_aware_erp = mean_aware_erp_early_runs;
    mean_unaware_erp = mean_unaware_erp_early_runs;
    awareTotals = awareTotals_early_runs;
    unawareTotals = unawareTotals_early_runs;
...
creationFunction = 'aoa_hpc_plot_mean_erp_split_designations_runs_early.m'
save('/vast/palmer/pi/blumenfeld/dsj8/AoA_Study/aoa_group_erp_means_split_designations_runs_early.mat','avg_erp_all_channels_aware_subjects','avg_erp_all_channels_unaware_subjects','allSubjectMeansAware','allSubjectMeansUnaware','creationFunction')
