...
fileLocation = '/mnt/Data8/HNCT_AoA_Study/AoA_Subjects/851/Day3/';
cd(fileLocation)
...
filename = '/mnt/Data8/HNCT_AoA_Study/AoA_Subjects/851/Day3/raw_EEG.raw';
...
cd(fileLocation)
disp('Loading file...')
if ~isfile([fileLocation sessionDate '_EGI.mat'])
    EEG = pop_readegi(filename)

    eval(['save ' fileLocation sessionDate '_EGI.mat EEG -v7.3']);
elseif isfile([fileLocation sessionDate '_EGI.mat'])
    disp('File already made.')
    load([fileLocation sessionDate '_EGI.mat'])
end
loadDuration = toc
...
cd(fileLocation)
tic
eval(['save ' fileLocation sessionDate '_bad_channels_samples.mat bad_channels bad_samples -v7.3']);
eval(['save ' fileLocation sessionDate '_EEG_avgref.mat EEG_avgref -v7.3']);
