%% Performs cluster permutation on trial-counterbalanced data.
function output_end = aoa_cluster_permutation_v2_voltage_parallel_counterbalance(data_type,window,suffix)
    ...
    creationFunction = 'aoa_cluster_permutation_v2_voltage_parallel_counterbalance.m';
    if strcmp(suffix, '')
