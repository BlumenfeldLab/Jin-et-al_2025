%% This script analyzes any EEG file with a room designation of "NL09" (see raw EEG data)
clear all
clc

%% Instantiate variables and load outputs from session level processing
...
for event = 2:length(Event_Types)-7
    if strcmp(Event_Types{event},'DIN3') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN2') && strcmp(Event_Types{event+3},'DIN1') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN2') && strcmp(Event_Types{event+6},'DIN1') 
    ...
    if strcmp(Event_Types{event},'DIN3') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN1') && strcmp(Event_Types{event+3},'DIN2') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN1') %&& strcmp(Event_Types{event+6},'DIN3')
        confirmTimes = [confirmTimes Event_Times{event}];
        previousClickPast = [previousClickPast Event_Times{event}-Event_Times{event-1}];
        previousConfirmPast = [previousConfirmPast Event_Times{event}-Event_Times{event-2}];
    ...
    if strcmp(Event_Types{event},'DIN3') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN2') && strcmp(Event_Types{event+3},'DIN1') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN1') %&& strcmp(Event_Types{event+6},'DIN3')
        confirmTimes = [confirmTimes Event_Times{event}];
        previousClickPast = [previousClickPast Event_Times{event}-Event_Times{event-1}];
        previousConfirmPast = [previousConfirmPast Event_Times{event}-Event_Times{event-2}];
        weirdQuizEvents = [weirdQuizEvents event];
    ...
    if strcmp(Event_Types{event},'DIN3') && strcmp(Event_Types{event+1},'DIN1') && strcmp(Event_Types{event+2},'DIN2') && strcmp(Event_Types{event+3},'DIN2') && strcmp(Event_Types{event+4},'DIN1')
        confirmTimes = [confirmTimes Event_Times{event}];
        previousClickPast = [previousClickPast Event_Times{event}-Event_Times{event-1}];
        previousConfirmPast = [previousConfirmPast Event_Times{event}-Event_Times{event-2}];
        weirdQuizEvents = [weirdQuizEvents event];
    ...
    if strcmp(Event_Types{event},'DIN4') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN2') && strcmp(Event_Types{event+3},'DIN1') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN2') && strcmp(Event_Types{event+6},'DIN1')
        badDesignations = [badDesignations designationCount];
        designationCount = designationCount + 1;
        
    end
    if strcmp(Event_Types{event},'DIN4') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN1') && strcmp(Event_Types{event+3},'DIN2') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN1')
        badDesignations = [badDesignations designationCount];
        designationCount = designationCount + 1;
        
    end
    if strcmp(Event_Types{event},'DIN4') && strcmp(Event_Types{event+1},'DIN2') && strcmp(Event_Types{event+2},'DIN2') && strcmp(Event_Types{event+3},'DIN1') && strcmp(Event_Types{event+4},'DIN2') && strcmp(Event_Types{event+5},'DIN1')
        badDesignations = [badDesignations designationCount];
        designationCount = designationCount + 1;
        
    end
    if event > 3
        if strcmp(Event_Types{event+1},'DIN1') && strcmp(Event_Types{event+2},'DIN3') && strcmp(Event_Types{event+3},'DIN4') && strcmp(Event_Types{event+4},'DIN2')
            runEndTimes = [runEndTimes Event_Times{event}];
            a = event;
        end
    end
    if event > 3
        if strcmp(Event_Types{event},'DIN4') && strcmp(Event_Types{event-1},'DIN1') && strcmp(Event_Types{event-2},'DIN1') && strcmp(Event_Types{event-3},'DIN1')
